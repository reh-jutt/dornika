    ...
    <header>
        <div class="container">
            <nav class="navbar">
                ...
                <ul class="nav-list">
                    <li class="nav-item">
                        <a href="main1" class="nav-link">Home</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link active">Bakers</a>
                    </li>
                </ul>
            </nav>
        </div>
    ...
    <section class="bakers">
        <div class="container">
            <div class="global-headline">
                ...
                <h3 class="headline headline-dark">Owners</h3>
                <div class="asterisk"><i class="fas fa-asterisk"></i></div>
            </div>
            <div class="bakers__container">
                <div class="baker">
                    <img src="css/images/baker-1.jpg" alt="baker">
                    <h5>John Doe</h5>
                ...
                <div class="baker">
                    <img src="css/images/baker-2.jpg" alt="baker">
                    <h5>Smith Doe</h5>
                    <ul class="social-icons">
                        <li>
                            <a href="#">
                ...
                <div class="baker">
                    <img src="css/images/baker-3.jpg" alt="baker">
                    <h5>Jane Doe</h5>
                    <ul class="social-icons">
                        <li>
                            <a href="#">
                ...
                <!-- <div class="baker">
                    <img src="css/images/baker-4.jpg" alt="baker">
                    <h5>Chris Doe</h5>
                    <ul class="social-icons">
                        <li>
                            <a href="#">
        ...
        <div class="container">
            <div class="row">
                <div class="image padding-right animate-left">
                    <img src="css/images/about-img-1.jpeg" alt="bread">
                </div>
                <div class="description animate-right">
                    <div class="global-headline">
                        ...
                        <h3 class="headline headline-dark">Join Us</h3>
                        <div class="asterisk"><i class="fas fa-asterisk"></i></div>
                    </div>
